...
def main():
    ...
    for company in data["companies"]:
        # Not: yalnızca approx=true olanlara değil, TÜM eşleşen firmalara
        # bakıyoruz. Çünkü bazı firmalar Nominatim'den "başarılı" ama yanlış
        # (ör. genel Tekirdağ merkezi gibi) bir sonuç alıp approx=false
        # olarak işaretlenmiş olabilir - bunlar da düzeltilmeli.
